		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#documentintelligence-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"documentintelligence-display": {
								"semanticObject": "documentintelligence",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=documentintelligence",
									"url": sap.ui.require.toUrl("documentintelligence")
								}
							}
						}
					}
