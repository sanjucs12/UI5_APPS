		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reservation",
									"targetURL": "#aiwmreservation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aiwmreservation-display": {
								"semanticObject": "aiwmreservation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aiwmreservation",
									"url": sap.ui.require.toUrl("aiwmreservation")
								}
							}
						}
					}
