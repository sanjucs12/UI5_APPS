		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customer Info",
									"targetURL": "#fragmentdialogapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fragmentdialogapp-display": {
								"semanticObject": "fragmentdialogapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fragmentdialogapp",
									"url": sap.ui.require.toUrl("fragmentdialogapp")
								}
							}
						}
					}
