		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "StockIN PO ",
									"targetURL": "#airditaiwmsckinpoaiwmpo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"airditaiwmsckinpoaiwmpo-display": {
								"semanticObject": "airditaiwmsckinpoaiwmpo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=airdit.aiwm.sckinpo.aiwmpo",
									"url": sap.ui.require.toUrl("airdit/aiwm/sckinpo/aiwmpo")
								}
							}
						}
					}
