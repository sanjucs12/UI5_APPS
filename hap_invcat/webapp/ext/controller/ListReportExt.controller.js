    ...
    return {
        handleUploadButtonClick: function (oEvent) {
            if (!this.importDialog) {
                this.importDialog = sap.ui.xmlfragment("hapinvcat.ext.fragment.fileUpload", this);
            }
        ...
        handleUploadComplete: function (oEvent) {
            ...
            this.extensionAPI.refreshTable(
                "hapinvcat::sap.suite.ui.generic.template.ListReport.view.ListReport::ZC_INV_CATEGORY--listReport");
            this.importDialog.destroy();
            this.importDialog = null;
        },
