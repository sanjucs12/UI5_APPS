		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#aidgruleconfig-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aidgruleconfig-display": {
								"semanticObject": "aidgruleconfig",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aidgruleconfig",
									"url": sap.ui.require.toUrl("aidgruleconfig")
								}
							}
						}
					}
