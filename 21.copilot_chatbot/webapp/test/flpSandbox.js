		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chat bot",
									"targetURL": "#copilotchatbot-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"copilotchatbot-display": {
								"semanticObject": "copilotchatbot",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=copilotchatbot",
									"url": sap.ui.require.toUrl("copilotchatbot")
								}
							}
						}
					}
