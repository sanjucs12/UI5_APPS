					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Heirarchy",
									"targetURL": "#qudgtree-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"qudgtree-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=qudgtree",
									"url": sap.ui.require.toUrl("qudgtree")
								}
							}
						}
					}
