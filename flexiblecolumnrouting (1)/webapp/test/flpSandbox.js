		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#flexiblecolumnrouting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"flexiblecolumnrouting-display": {
								"semanticObject": "flexiblecolumnrouting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=flexiblecolumnrouting",
									"url": sap.ui.require.toUrl("flexiblecolumnrouting")
								}
							}
						}
					}
